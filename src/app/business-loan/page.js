    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-16">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <h1 className="text-3xl font-bold text-blue-600 mb-8">Business Loan</h1>
          
          {/* Features Section */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-blue-600 mb-6">Loan Features</h2>
          ...
          {/* Eligibility Section */}
          <section>
            <h2 className="text-2xl font-semibold text-blue-600 mb-6">Eligibility Requirements</h2>
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg className="w-6 h-6 text-blue-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-700">Annual revenue of $100,000+</span>
              </li>
              <li className="flex items-start">
                <svg className="w-6 h-6 text-blue-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-700">Good credit history</span>
              </li>
            </ul>
          </section>
        </div>
